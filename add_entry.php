...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($title) || empty($content) || empty($entry_date)) {
        ...
        $sql = "INSERT INTO diary_entries
                (user_id, title, content, mood, entry_date, status)
                VALUES (?, ?, ?, ?, ?, ?)";
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("Location: dashboard.php?success=entry_added");
            exit();
                ...
                <div class="glass-card p-lg md:p-xl flex flex-col gap-lg shadow-2xl shadow-black/20">
                    ...
                    <div class="flex flex-col gap-xs relative mt-md flex-grow">
                        <textarea
                            ...
                            placeholder="What's on your mind today?..." name="content"></textarea>
                        <div
